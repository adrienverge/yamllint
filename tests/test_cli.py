...
class CommandLineTestCase(unittest.TestCase):
    ...
    def test_find_files_recursively(self):
        ...
        items = [os.path.join(self.wd, 'empty.yml'), os.path.join(self.wd, 's')]
        self.assertEqual(
            sorted(cli.find_files_recursively(items, conf)),
            [
                os.path.join(self.wd, 'empty.yml'),
    ...
    def test_run_with_implicit_extends_config(self):
        ...
        expected_out = (
            f'{path}:1:1: [warning] missing document start "---" ' f'(document-start)\n'
        )
        self.assertEqual(
...
class CommandLineConfigTestCase(unittest.TestCase):
        ...
        for conf_file in ('.yamllint', '.yamllint.yml', '.yamllint.yaml'):
            with self.subTest(conf_file):
                ...
                self.assertEqual(
                    ...
                    (
                        0,
                        './a.yml:1:1: [warning] missing document '
    ...
    def test_multiple_parent_config_file(self):
        ...
        self.assertEqual(
            ...
            (
                0,
                './3spaces.yml:2:4: [warning] wrong indentation: '
        ...
        self.assertEqual(
            ...
            (
                0,
                './4spaces.yml:2:5: [warning] wrong indentation: '
